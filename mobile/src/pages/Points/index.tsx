  ...
  return (
    <>
      <View style={styles.container} >
        <TouchableOpacity style={styles.boxBack} onPress={handleNavigateBack}>
      ...
      <View style={styles.itemsContainer}>
        <ScrollView showsHorizontalScrollIndicator={false} contentContainerStyle={{ paddingHorizontal: 20 }} horizontal>
          {items.map(item => (
            <TouchableOpacity
              key={String(item.id)}
              style={[
